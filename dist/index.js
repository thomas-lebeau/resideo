...
const resideo_1 = require("./resideo");
...
async function main() {
    ...
    try {
        switch (command) {
            case 'resideo':
                await (0, resideo_1.collectThermostatData)();
                break;
            case 'hue':
                await (0, hue_1.collectHueLightData)();
                break;
            case undefined:
            case 'all':
                await runMonitoring();
